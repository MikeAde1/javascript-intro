const store = {
  ...
  //since real asynchrnous operations take variable amounts of time
  function generateRandomDelay() {
    return Math.floor(Math.random() * 2000);
  }
  
//setTimeout() is a Node function which delays the execution of a callback function using the event-loop.
// We use .then() with a success handler callback containing 
//the logic for what should happen if a promise resolves.
